...
In XCode import `Marketo` in Ihre `AppDelegate.m` -Datei ,
...
Fügen Sie `App.tsx` hinzu, um Push-Benachrichtigungen zuzulassen
...
Aktualisieren Sie `AppDelegate.mm` mit den APNS-Delegierungsmethoden:
