...
Eine Partner-Sandbox ist eine Marketo Engage-Instanz, die von Partnern während des Software-Entwicklungslebenszyklus verwendet wird. Partner verwenden ihre Sandbox, um sich mit der Marketo Engage-Benutzeroberfläche vertraut zu machen und Zugriff auf Marketo Engage-API-Services zu erhalten.

Eine Sandbox wird bereitgestellt, nachdem ein Partner für das [Adobe Exchange-Partnerprogramm „Digital Experience“ &#x200B;](https://partners.adobe.com/technologyprogram/experiencecloud.html) wurde. In den meisten Fällen entsprechen Partner-Sandboxes einer Produktionsinstanz. In Partner-Sandboxes sind keine Add-on-Module installiert und es sind feste Kapazitätsbeschränkungen vorhanden. Nachstehend finden Sie eine FAQ gefolgt von einer Zusammenfassung der Partner-Sandbox-Funktionen.
